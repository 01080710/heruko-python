...
=======
    ...
    年份 = models.CharField("年份",max_length=50, null=True)  
    WMI = models.CharField("WMI",max_length=50, null=True)  
    VDS = models.CharField("VDS",max_length=50, null=True)  
    VALADATION = models.CharField("VALADATION",max_length=50, null=True) 
    TOYOTA進口_VALADATION = models.CharField("TOYOTA進口_VALADATION",max_length=50, null=True)
    VIS_min = models.CharField("VIS_min",max_length=50, null=True) 
    VIS_max = models.CharField("VIS_max",max_length=50, null=True)
    match = models.CharField("match",max_length=50, null=True) 
    車身碼 = models.CharField("車身碼",max_length=50, null=True)  
    中文等級 = models.CharField("中文等級",max_length=50, null=True)  
    排氣量 = models.CharField("排氣量",max_length=50, null=True)  
    價格 = models.CharField("價格",max_length=50, null=True) 
    估價日期 = models.CharField("估價日期",max_length=50, null=True)  
    保險到期日 = models.CharField("保險到期日",max_length=50, null=True)  
    銷售日 = models.CharField("銷售日",max_length=50, null=True) 
    統計代碼 = models.CharField("統計代碼",max_length=50, null=True) 
    限乘人數 = models.CharField("限乘人數",max_length=50, null=True)  
    Label = models.CharField("Label",max_length=50, null=True)  
    ...
    VIS_min_false = models.CharField("VIS_min_false",max_length=50, null=True) 
    VIS_max_false = models.CharField("VIS_max_false",max_length=50, null=True) 
...
>>>>>>> 16ecf7644890736520908a9d6f32d848b37ba87d
    ...
    # 使用實際存在的欄位名稱
    class Meta:
        ordering = ['類型', '車種', 'CARMDL', 'SFX','出廠年月','年份','WMI','VDS','VALADATION','TOYOTA進口_VALADATION','VIS_min','VIS_max','match','車身碼','中文等級',
